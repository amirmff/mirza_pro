...
show_menu() {
    ...
    echo -e "${BLUE}Bot Status:${NC} $(get_bot_status)"
    echo ""
    echo -e "${YELLOW}═══════════════════════════════════════${NC}"
    echo ""
    echo "  ${CYAN}1.${NC} Start Bot"
    echo "  ${CYAN}2.${NC} Stop Bot"
    echo "  ${CYAN}3.${NC} Restart Bot"
    echo "  ${CYAN}4.${NC} View Bot Status"
    echo "  ${CYAN}5.${NC} View Live Logs"
    echo "  ${CYAN}6.${NC} View Last 50 Lines of Log"
    echo ""
    echo -e "${YELLOW}───────────────────────────────────────${NC}"
    echo ""
    echo "  ${CYAN}7.${NC} Database Info"
    echo "  ${CYAN}8.${NC} Backup Database"
    echo "  ${CYAN}9.${NC} View System Info"
    echo ""
    echo -e "${YELLOW}───────────────────────────────────────${NC}"
    echo ""
    echo "  ${CYAN}10.${NC} Update Bot (from GitHub)"
    echo "  ${CYAN}11.${NC} Edit Configuration"
    echo "  ${CYAN}12.${NC} Open Web Panel URL"
    echo ""
    echo -e "${YELLOW}───────────────────────────────────────${NC}"
    echo ""
    echo "  ${RED}0.${NC} Exit"
